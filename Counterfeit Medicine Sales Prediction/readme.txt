...
to predict sales figures given an illegal operation's characteristic

In this we will be predicting the sales based on training with past data collected.
